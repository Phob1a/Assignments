public class Process implements Comparable<Process> {
	...
	public int compareTo(Process arg0) {
		...
		//return Scheduler.jud(Process arg0);
		if(this.getPriority()>arg0.getPriority()) return 1;
		if(this.getPriority()<arg0.getPriority()) return -1;
		if(this.getProcessID()<arg0.getProcessID()) return 1;
		return -1;
		//return Scheduler.jud(this,arg0);

/*
		if(this.getBurstRemaining()<arg0.getBurstRemaining()) return -1;
		if(this.getBurstRemaining()>arg0.getBurstRemaining()) return 1;
		//if(this.getArrivalTime()>arg0.getArrivalTime()) return 1;
		return 0;
*/
	}
